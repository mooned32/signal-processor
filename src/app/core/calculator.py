...
def calculate_data(
    ...
    Выполняет расчет.
    Возвращает:
      (preview_df [до столбца x], extended_df [со столбцами y и W], x_is_alert, violating_c).
    """
    _ = z_value
    ...
    # Список значений C с нарушениями
